...
import graphql.extended.validation.util.DirectivesAndTypeWalker;
...
import static graphql.extended.validation.rules.ValidationEnvironment.ValidatedElement.FIELD;
...
public abstract class AbstractDirectiveConstraint implements DirectiveConstraint {
    ...
    /**
     * Creates  a new {@link GraphQLError}
     *
    ...
    /**
     * Return true if the type is a String or List type or {@link GraphQLInputObjectType}, regardless of non null ness
     *
     * @param inputType the type to check
