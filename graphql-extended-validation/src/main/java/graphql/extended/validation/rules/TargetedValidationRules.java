...
import graphql.extended.validation.locale.LocaleUtil;
...
import static graphql.extended.validation.rules.ValidationEnvironment.ValidatedElement.*;

/**
 * TargetedValidationRules is a holder of {@link ValidationRule}s targeted against a specific
...
public class TargetedValidationRules {
    ...
    /**
     * Runs the contained rules that match the currently executing field named by the {@link DataFetchingEnvironment}
     *
