...
class GraphQLLocalDateTimeTest extends Specification {
    ...
    def "Date parse literal #literal.value as #result"() {
        ...
        new StringValue('2017-07-09 11:54:42')      | LocalDateTime.of(2017, 7, 9, 11, 54, 42)
    ...
    def "Date serialize #value into #result (#result.class)"() {
        ...
        where:
        value                                                                     | result
        LocalDateTime.of(2017, 7, 9, 11, 54, 42, (int) MILLISECONDS.toNanos(277)) | '2017-07-09 11:54:42'
        LocalDateTime.of(2017, 7, 9, 13, 14, 45, (int) MILLISECONDS.toNanos(947)) | '2017-07-09 13:14:45'
        LocalDateTime.of(2017, 7, 9, 11, 54, 42)                                  | '2017-07-09 11:54:42'
        LocalDateTime.of(LocalDate.of(2017, 7, 9), LocalTime.MIDNIGHT)            | '2017-07-09 00:00:00'
    }
    ...
    def "serialize #value into #result (#result.class) using zone conversion"() {
        ...
        where:
        value                                                                       | result
        LocalDateTime.of(2017, 7, 9, 11, 54, 42, (int) MILLISECONDS.toNanos(277))   | '2017-07-09 10:54:42'
        LocalDateTime.of(2017, 7, 9, 13, 14, 45, (int) MILLISECONDS.toNanos(947))   | '2017-07-09 12:14:45'
        LocalDateTime.of(2017, 7, 9, 11, 54, 42)                                    | '2017-07-09 10:54:42'
        LocalDateTime.of(LocalDate.of(2017, 7, 9), LocalTime.MIDNIGHT.plusHours(1)) | '2017-07-09 00:00:00'
    }
